...
require('lazy').setup({
  ...
  requires = 'nvim-tree/nvim-web-devicons', -- Required for icons
  config = function()
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'go', 'lua', 'python', 'rust', 'tsx', 'typescript', 'vimdoc', 'vim', 'sql', 'javascript'},
...
vim.cmd('set expandtab')      -- Use tabs instead of spaces
-- Set the default tab width to 2 spaces for JavaScript files
-- autocmd FileType javascript setlocal shiftwidth=2 tabstop=2 softtabstop=2 expandtab
-- Set default tab settings to 2 spaces for JavaScript files
-- vim.cmd('autocmd FileType javascript setlocal tabstop=2 softtabstop=2 shiftwidth=2 expandtab')
-- Use 2 spaces for tabs only in JavaScript files
vim.cmd[[
